...
For the folder layout shown in your GitHub screenshot:

```text
games/retrobowl/index.html
games/retrobowl/html5game/
```
...
{
  "title": "Retro Bowl",
  "description": "A browser football game.",
  "image": "images/game-placeholder.svg",
  "tags": ["Football", "HTML5"],
  "type": "local",
  "target": "retrobowl/index.html"
}
```

You can also enter `retrobowl` or `retrobowl/` in the Add Game helper, and it will turn that into `retrobowl/index.html`.
...
## Use The Owner Helper

The owner helper is a separate file named `books777-owner-add-game.html`. Keep it on your computer and do not upload it to GitHub Pages.

Open `books777-owner-add-game.html`, enter the game link and image, then copy the generated database entry.
...
Upload the changed files from the public site folder to GitHub and commit them. GitHub Pages will rebuild the site automatically.

Do not upload `books777-owner-add-game.html` unless you want other people to be able to open it.
